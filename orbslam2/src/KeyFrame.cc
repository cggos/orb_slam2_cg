...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB) : 
    ...
    N(F.N), mvKeys(F.mvKeys), mvKeysUn(F.mvKeysUn), mvuRight(F.mvuRight), mvDepth(F.mvDepth), mDescriptors(F.mDescriptors.clone()), 
    mfeT(F.mfeT.clone()), mpCameraFE(F.mpCameraFE), 
    N_Fisheye(F.N_Fisheye), mvKeysFisheye(F.mvKeysFisheye), mvKeysIdxFisheyeStereo(F.mvKeysIdxFisheyeStereo),
